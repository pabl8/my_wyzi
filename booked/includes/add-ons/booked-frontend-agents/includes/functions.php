...
function booked_profile_content_fea_appointments(){
	?>
	<ul class="nav nav-tabs card-header-tabs" style="border:0;" id="appointment-subnav" role="tablist">
		<li class="nav-item active">
			<a class="nav-link" id="bus-appt" data-toggle="tab" href="#bus-appt-content" role="tab" aria-controls="One" aria-selected="true"><?php esc_html_e( 'Business Appointments', 'wyzi-business-finder' );?></a>
		</li>
		<li class="nav-item">
			<a class="nav-link" id="cl-appt" data-toggle="tab" href="#cl-appt-content" role="tab" aria-controls="Two" aria-selected="false"><?php esc_html_e( 'My Appointments', 'wyzi-business-finder' );?></a>
		</li>
	</ul>

	<div class="tab-content" id="appointment-subnav-content">
		<div class="tab-pane fade active p-3 in" id="bus-appt-content" role="tabpanel" aria-labelledby="bus-appt">
			<?php echo do_shortcode('[booked-fea-appointments remove_wrapper=1]');?>
		</div>
		<div class="tab-pane fade p-3" id="cl-appt-content" role="tabpanel" aria-labelledby="cl-appt">
...
function booked_profile_content_fea_history(){
	?>
	<ul class="nav nav-tabs card-header-tabs" style="border:0;" id="appointment-history-subnav" role="tablist">
		<li class="nav-item active">
			<a class="nav-link" id="bus-appt-hist-tab" data-toggle="tab" href="#bus-appt-hist" role="tab" aria-controls="One" aria-selected="true"><?php esc_html_e( 'Business Appointments', 'wyzi-business-finder' );?></a>
		</li>
		<li class="nav-item">
			<a class="nav-link" id="cl-appt-hist-tab" data-toggle="tab" href="#cl-appt-hist" role="tab" aria-controls="Two" aria-selected="false"><?php esc_html_e( 'My Appointments', 'wyzi-business-finder' );?></a>
		</li>
	</ul>

	<div class="tab-content" id="appointment-history-subnav-content">
		<div class="tab-pane fade active p-3 in" id="bus-appt-hist" role="tabpanel" aria-labelledby="bus-appt-hist-tab">
			<?php echo do_shortcode('[booked-fea-appointments remove_wrapper=1 historic=1]');?>
		</div>
		<div class="tab-pane fade p-3" id="cl-appt-hist" role="tabpanel" aria-labelledby="cl-appt-hist-tab">
			<?php echo do_shortcode('[booked-appointments remove_wrapper=1 historic=1]');?>
		</div>
	</div>
	<?php
}
