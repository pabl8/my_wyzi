...
?><div class="booked-appointment-details" data-appt-key="<?php echo $appointment_key; ?>">
	<?php
		...
		if ( $price != 0): 
			?><p class="appointment-info"><i class="booked-icon booked-icon-money"></i>&nbsp;&nbsp;&nbsp;<?php echo sprintf( esc_html__( 'Price: ','wyzi-business-finder') . get_woocommerce_price_format() , get_woocommerce_currency_symbol() , $price ); ?></p><?php
		endif;

		echo $appt_date_time_after;
		do_action( 'wyz_after_booking_appointment_details', $calendar_id );
