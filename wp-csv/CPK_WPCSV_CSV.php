...
class CPK_WPCSV_CSV {
	...
	public function file_valid( $file_path ) {
		...
		if ( count( $title_row ) == 1 ) {
			$this->log_model->add_message( "Only one column found.  Are you sure your spreadsheet program saved this file with the correct delimiter and enclosure characters?" );
			$this->log_model->store_messages( );
			return FALSE;
		}
