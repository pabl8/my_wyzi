...
<table class='widefat'>
<thead>
<tr><th colspan='2'><strong><?php _e( 'Export To CSV', 'wyzi-business-finder' ); ?></strong></th></tr>
</thead>
<tbody>
<tr><th><?php _e( 'Progress', 'wyzi-business-finder' ); ?></th><td><div id="progressbar_holder"><div id="progressbar"></div></div><span id='percent'>(0%)</span>
<div id="download_link">
<a href='<?php echo $export_link; ?>'><?php _e( 'Download CSV File', 'wyzi-business-finder' ); ?></a>
<?php if ( $debug ): ?>
<p>
Debug Active: <a href='<?php echo $debug_link; ?>'><?php _e( 'Download Debug File', 'wyzi-business-finder' ); ?></a>
</p>
<?php endif; ?>
</div>
<p id='nothing-to-export'><?php _e( 'You seem to have nothing to export.  Add a post or page and try again.', 'wyzi-business-finder' ); ?></p>
</td></tr>
